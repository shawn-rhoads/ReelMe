...
movie_displays = read_movie_file("data/movies.csv")
...
if st.session_state.pressed:
    ...
    list_other = float(st.session_state.list_end - st.session_state.list_search_end)
    ...
    mat_other = float(st.session_state.mat_end - st.session_state.mat_search_end)
